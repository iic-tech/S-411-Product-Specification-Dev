...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icecomTemplate" match="ice:icecom">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icecom/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icecom.svg'"/>
