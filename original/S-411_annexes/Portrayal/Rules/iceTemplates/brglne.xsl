...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="brglneTemplate" match="ice:brglne">
        <xsl:call-template name="lineComplexStyleTemplate">
            ...
            <xsl:with-param name="symbolReference" select="'../../LineStyles/brglne.svg'"/>
