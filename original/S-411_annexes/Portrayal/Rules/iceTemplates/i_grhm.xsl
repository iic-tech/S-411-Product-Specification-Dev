...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="i_grhmTemplate" match="ice:i_grhm">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:i_grhm/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/i_grhm.svg'"/>
