...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="flobrgTemplate" match="ice:flobrg">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:flobrg/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/flobrg.svg'"/>
