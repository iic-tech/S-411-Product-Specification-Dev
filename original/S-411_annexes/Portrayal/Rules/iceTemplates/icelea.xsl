...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="iceleaTemplate" match="ice:icelea">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icelea/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icelea.svg'"/>
