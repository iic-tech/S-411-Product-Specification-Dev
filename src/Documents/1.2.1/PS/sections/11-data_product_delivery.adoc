...
It is recommended to compress all the dataset files, for example MGL files. The ZIP compression method defined in <<iho-s100,part=15,clause=5.2>> must be applied to the product files.

==== Use of data protection
It is recommended to encrypt all the dataset files, for example GML. The encryption method defined in <<iho-s100,part=15>> must be applied.
