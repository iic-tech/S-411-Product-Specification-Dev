...
image::figure-components-and-associated-metadata-for-the-s411-exchange-set.png[]
...
image::figure-relationship-between-exchange-catalogue-discovery-metadata-and-dataset.png[]
...
image::figure-s411-exchange-set-class-details.png[]
