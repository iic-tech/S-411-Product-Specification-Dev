...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="i_fralTemplate" match="ice:i_fral">
        <xsl:call-template name="lineComplexStyleTemplate">
            ...
            <xsl:with-param name="symbolReference" select="'../../LineStyles/i_fral.svg'"/>
