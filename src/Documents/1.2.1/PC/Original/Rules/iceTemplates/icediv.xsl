...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icedivTemplate" match="ice:icediv">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icediv/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icediv.svg'"/>
