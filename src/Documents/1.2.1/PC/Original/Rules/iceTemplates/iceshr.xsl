...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="iceshrTemplate" match="ice:iceshr">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:iceshr/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/iceshr.svg'"/>
