...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icerftTemplate" match="ice:icerft">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icerft/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icerft.svg'"/>
