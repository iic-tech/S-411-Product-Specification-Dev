...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icefraTemplate" match="ice:icefra">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icefra/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icefra.svg'"/>
