...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="i_leadTemplate" match="ice:i_lead">
        <xsl:call-template name="lineComplexStyleTemplate">
            ...
            <xsl:with-param name="symbolReference" select="'../../LineStyles/i_lead.svg'"/>
