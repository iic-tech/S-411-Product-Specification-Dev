...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icerdgTemplate" match="ice:icerdg">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icerdg/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icerdg.svg'"/>
