...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="i_ridgTemplate" match="ice:i_ridg">
        <xsl:call-template name="lineComplexStyleTemplate">
            ...
            <xsl:with-param name="symbolReference" select="'../../LineStyles/i_ridg.svg'"/>
