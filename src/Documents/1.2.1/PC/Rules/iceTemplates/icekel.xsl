...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="icekelTemplate" match="ice:icekel">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:icekel/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/icekel.svg'"/>
