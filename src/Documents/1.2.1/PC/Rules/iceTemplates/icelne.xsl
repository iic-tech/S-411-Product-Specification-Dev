...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ice="http://www.iho.int/ice"
    ...
    <xsl:template name="icelneTemplate" match="ice:icelne">
        <xsl:call-template name="lineSimpleStyleTemplate">
            <xsl:with-param name="featureReference" select="ice:icelne/@gml:id"/>
            ...
            <xsl:with-param name="colorToken" select="'0 0 0'"/>
