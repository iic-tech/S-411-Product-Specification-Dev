...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="jmdbrrTemplate" match="ice:jmdbrr">
        <xsl:call-template name="pointSimpleSymbolTemplate">
            <xsl:with-param name="featureReference" select="ice:jmdbrr/@gml:id" />
            ...
            <xsl:with-param name="symbolReference" select="'../../Symbols/jmdbrr.svg'"/>
